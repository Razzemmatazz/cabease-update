...
var CLIENT_ID =
  "603339008605-1q1ou5u42kb7a0vk5ctb9e4j759bd0e0.apps.googleusercontent.com";
var API_KEY = "AIzaSyBG0mA1AS8LTyEmdVE1XH1YXXKIzY61HVc";
...
function initClient() {
  gapi.client
    ...
    .then(function() {
      ...
      gapi.client
        .load("https://script.googleapis.com/$discovery/rest?version=v1")
        .then(function() {
